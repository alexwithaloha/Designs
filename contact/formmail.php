...
$TARGET_EMAIL = array("^alexshortsleeve@yahoo\.com$");

/* Help: http://www.tectite.com/fmdoc/def_alert.php */
$DEF_ALERT ="toni@konikodes.com";
...
$REQUIRE_CAPTCHA = "Click to Confirm that you are not a robot."; /* set to a message string if your forms */
// must provide a CAPTCHA string

/* Help: http://www.tectite.com/fmdoc/recaptcha_private_key.php */
$RECAPTCHA_PRIVATE_KEY = "6LcQDSATAAAAAKmejcvhG2WzGoymtjAyIaPidzBy";
